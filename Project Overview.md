...
2. What are similarities for those customers who accept term deposit?
3. How many call attemps should we make to convince customer? 
4. For retargeting customers from previous campaign, what is the successful rate ?
